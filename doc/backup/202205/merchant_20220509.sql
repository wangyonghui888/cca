ALTER TABLE merchant.m_user   ADD secret varchar(255) DEFAULT NULL COMMENT '谷歌秘钥' AFTER password;
ALTER TABLE merchant.m_user   ADD is_enable tinyint(4)  DEFAULT 1 COMMENT '1 启用 0禁用'  AFTER password;

DROP INDEX index_domain_name ON t_domain;
alter  table merchant.t_domain add   unique uniq_merchant_group_id(merchant_group_id,domain_name);

ALTER TABLE merchant.m_maintenance_record   ADD plan_end_time bigint(20) DEFAULT NULL COMMENT '计划结束时间' AFTER real_start_time;
