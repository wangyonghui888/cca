...
DELIMITER //
CREATE
    PROCEDURE `p_r_merchant_order_month`(in str_date varchar(100))
BEGIN
...
from (
    ...
    UNIX_TIMESTAMP(current_timestamp(3)),
    sum(ru.order_valid_bet_money)     order_valid_bet_money,
    sum(ru.settle_valid_bet_money)    settle_valid_bet_money
