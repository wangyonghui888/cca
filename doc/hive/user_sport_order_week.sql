...
FROM   (SELECT a.uid                uid,
        ...
        FROM   dwm_report.t_settle_full_detail a
               LEFT JOIN dwm_report.t_order_full_detail s
       ...
       LEFT JOIN (SELECT a.uid                uid,
                  ...
                  FROM   dwm_report.t_order_full_detail a
                         LEFT JOIN dwm_report.t_settle_full_detail s
                                ON a.order_no = s.order_no
       ...
       LEFT JOIN(SELECT uid      AS uid,
                 ...
                 FROM   (SELECT m.uid uid,
                         ...
                         FROM   (SELECT s.uid                                                                      uid,
                                 ...
                                 FROM   dwm_report.t_order_full_detail s) m
                         GROUP  BY m.uid,
                                   m.active_days
