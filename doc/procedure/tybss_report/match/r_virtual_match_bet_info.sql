DROP PROCEDURE IF EXISTS p_r_virtual_match_bet_info;
DELIMITER //
CREATE PROCEDURE p_r_virtual_match_bet_info(in execute_date varchar(100))
BEGIN
    /*声明日志信息*/
    DECLARE task_type INT(2) DEFAULT 202;
    DECLARE result_code CHAR(5) DEFAULT '0';
    DECLARE start_time VARCHAR(30) DEFAULT get_cur_ymdhms();
    DECLARE end_time VARCHAR(30);
    DECLARE result INT(2) DEFAULT 1;
    DECLARE exce_msg VARCHAR(512) DEFAULT 'p_r_virtual_match_bet_info成功';
    DECLARE msg TEXT;
...
/*异常处理*/
    DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
        ...
        SET exce_msg = CONCAT('错误码:', result_code, execute_date, 'p_r_virtual_match_bet_info错误信息：', msg);
        SET result = 2;
    ...
    from (select id,
         ...
         (SELECT d.match_id                                                                             matchId,
                 ...
                 SUM(CASE
                         ...
                         WHEN s.out_come in (3, 4, 5, 6) and
                              ABS(d.order_amount_total) < ABS(s.profit_amount)
                             THEN ABS(s.order_amount_total / 100) END)                    validBetAmount,
    ...
    SET exce_msg = CONCAT(execute_date, 'p_r_virtual_match_bet_info success!');
