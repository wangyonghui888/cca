...
BEGIN
    ...
    SELECT a.id,
           ...
           floor(a.order_valid_bet_money)  as order_valid_bet_money,
           floor(a.settle_valid_bet_money) as settle_valid_bet_money
    ...
    SELECT Concat(parent_code, sport_id, time)                                                 id,
           ...
           floor(sum(order_valid_bet_money))                                                   order_valid_bet_money,
           floor(sum(settle_valid_bet_money))                                                  settle_valid_bet_money
