DROP PROCEDURE if EXISTS tybss_merchant_common.p_user_seven_order;
DELIMITER //
CREATE PROCEDURE tybss_merchant_common.p_user_seven_order(in execute_date varchar(100))
BEGIN
    ...
    UPDATE tybss_merchant_common.t_user tu inner join (
    ...
    UPDATE tybss_merchant_common.t_user tu
    set tu.seven_day_bet_amount=0,
        tu.seven_day_profit_amount =0
    where tu.last_bet_time < unix_timestamp(DATE_ADD(execute_date, INTERVAL -6 DAY)) * 1000 - 1
       or tu.last_bet_time is null;
