...
public class RedisTemp {
     ...
     * @param
     */
    public void setWithExpireDay(String key, String value, int expireTime) {
    ...
    public void deleteByPattern(String keyPattern) {
        ...
        log.info("模糊匹配的key 总数= {}", keys.size());
     ...
     * @param value
     */
    public void setDays(String key, String value, Integer time) {
    ...
    public Object getObject(String key, Class clazz) {
        ...
        return ObjectUtil.isEmpty(value) ? null : JSON.parseObject(value.toString(), clazz);
    }
