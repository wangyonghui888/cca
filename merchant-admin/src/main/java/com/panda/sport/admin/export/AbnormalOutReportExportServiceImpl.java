 ...
 * --------  ---------  --------------------------
 */
@Service("abnormalOutReportExportServiceImpl")
@Slf4j
public class AbnormalOutReportExportServiceImpl extends AbstractAbnormalFileExportService {
    ...
    public void export(MerchantFile merchantFile) {
        ...
        try {
            ...
            //1为对外，0为对内
            inputStream = new ByteArrayInputStream(exportMatchToCsv(resultList, language,1));
    ...
    private Map<String, Object> findAdnormal(AbnormalVo abnormalVo) throws IOException {
        ...
        map= abnormalOutApiClient.queryAbnormalList(abnormalVo);
        return map;
    }
}
