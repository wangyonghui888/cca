 ...
 */
@RestController
@RequestMapping("/admin/reportMatch")
@Slf4j
public class MatchReportDateController {
    ...
    public Object reportDateList(HttpServletRequest request1, @RequestBody MatchBetInfoReq vo) {
        ...
        if(vo.getMerchantIds()==null || vo.getMerchantIds().size()<1) {
            List<String> merchantList = Lists.newArrayList();
            merchantList.add(merchantId);
            vo.setMerchantIds(merchantList);
        }
