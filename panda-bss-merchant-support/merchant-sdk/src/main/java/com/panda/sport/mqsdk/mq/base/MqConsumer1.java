...
@Slf4j
public class MqConsumer1 implements BeanPostProcessor {

    private Properties properties;


    public MqConsumer1(Properties properties) throws Exception {
...
/*                || properties.get(PropertyKeyConst.AccessKey) == null
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (null != annotation) {
            ...
            log.info("MqConsumer1 Consumer start ");
            try {
                ...
                consumer.registerMessageListener((MessageListenerConcurrently) (msgs, context) -> {
                    ...
                    try {
                        ...
                        log.error("MqConsumer1 Consumer get msg error:", e);
                        return ConsumeConcurrentlyStatus.RECONSUME_LATER;
                    }
                    return ConsumeConcurrentlyStatus.CONSUME_SUCCESS;
                });
                consumer.start();
                log.info("MqConsumer1 Consumer end");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private DefaultMQPushConsumer assemblyConsumer(Properties properties) throws MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer((String) properties.get(PropertyKeyConst.ConsumerId), getAclRPCHook(properties), new AllocateMessageQueueAveragely());
        ...
        consumer.setInstanceName("panda-sport-consumer1");
        // 程序第一次启动从消息队列头获取数据
    ...
    static RPCHook getAclRPCHook(Properties properties) {
        return new AclClientRPCHook(new SessionCredentials((String) properties.get(PropertyKeyConst.AccessKey),
                (String) properties.get(PropertyKeyConst.SecretKey)));
    }
}
