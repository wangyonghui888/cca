...
/**
 * @author :  ives
 * @Description :  账户中心/平台用户风控-查询用户风控分页列表请求VO
 * @Date: 2022-04-09
 */
@Data
@Api(value = "账户中心/平台用户风控-查询用户风控分页列表请求VO")
public class UserRiskControlPageQueryReqVO extends BasePage implements Serializable {
