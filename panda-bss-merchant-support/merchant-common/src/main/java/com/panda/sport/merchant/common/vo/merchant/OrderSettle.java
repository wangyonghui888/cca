...
public class OrderSettle implements Serializable {
    ...
    private List<OrderSettleDetail> orderDetailList;


    private List<OrderPreSettleDTO2> preSettleDetailList;
    /**
     * 用户id
     */
    private String uid;
    ...
    public void setVipUpdateTime(Long vipUpdateTime) {
        ...
        if (vipUpdateTime != null) {
            this.vipUpdateTimeStr = DateFormatUtils.format(new Date(vipUpdateTime), "yyyy-MM-dd HH:mm:ss");
        }
    }
}
