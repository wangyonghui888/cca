...
/**
 * @author :  ives
 * @Description :  电竞公告添加请求VO
 * @Date: 2022-03-08 17:18
 */
@Data
@Api(value = "电竞公告添加请求VO")
public class ESportsNoticeAddReqVO implements Serializable {

    private static final long serialVersionUID = 2042527555613472310L;
    /**
     * 必填字段
     */
