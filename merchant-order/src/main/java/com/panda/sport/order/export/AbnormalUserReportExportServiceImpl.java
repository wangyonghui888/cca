 ...
 * --------  ---------  --------------------------
 */
@Service("abnormalUserReportExportServiceImpl")
@Slf4j
public class AbnormalUserReportExportServiceImpl extends AbstractAbnormalFileExportService {
    @Autowired
    ...
    public void export(MerchantFile merchantFile) {
        ...
        try {
            ...
            sportVO.setUserId(null);
            sportVO.setAppId(null);
            ...
            inputStream = new ByteArrayInputStream(exportAbnormalUserMatchToCsv(resultList, language,0));
