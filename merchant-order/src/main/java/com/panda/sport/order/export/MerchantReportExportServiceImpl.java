...
public class MerchantReportExportServiceImpl extends AbstractOrderFileExportService {
    ...
    public void export(MerchantFile merchantFile){
        ...
        try {
            ...
            inputStream =  new ByteArrayInputStream(exportMerchantReportToCsv(returnData, requestVO.getFilter()));
    ...
    private byte[] exportMerchantReportToCsv(List<?> resultList, String filter) {
