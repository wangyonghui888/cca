...
public class CacheService {
    ...
    public static Cache<String, Object> userCheckBalanceMap = null;
    ...
    public static final String REDIS_CACHE_PREFIX = "merchant:username:";
    ...
    public boolean validateUserName(String merchantCode, String userName) {
        String key = REDIS_CACHE_PREFIX + merchantCode + userName;
        String bloomKey = merchantCode + "_" + userName;
        try {
            boolean contains = BloomInit.bloomFilter.mightContain(bloomKey);
            if (contains) {
                log.info("validateUserName--bloom--key:{}",key);
                return false;
            }
            UserPO userPO = (UserPO) redisTemp.getObject(key, UserPO.class);
            if(!Objects.isNull(userPO)){
                log.info("validateUserName--redis--key:{}",key);
                return false;
            }
            ...
            log.error(key + "validateUserName:", e);
            return true;
        }
    }
